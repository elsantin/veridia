...
const translations = {
    en: {
        nav_home: "Home", nav_services: "Services", nav_approach: "Approach", nav_value: "Potential Value", nav_contact: "Contact Us",
        hero_title: "Efficiency and Future. <span class='text-accent'>Automated.</span>", hero_subtitle: "Veridia designs and implements intelligent automation solutions that transform your operation and boost your growth.", hero_cta: "Start Consultation",
        problems_title: "Overcome Operational Limits", problems_subtitle: "Identify the barriers holding back your progress and discover how automation breaks them down.",
        problem1_title: "Slow Manual Processes", problem1_desc: "Free your team from repetitive, error-prone tasks.",
        problem2_title: "High Operational Costs", problem2_desc: "Optimize resources and reduce unnecessary expenses efficiently.",
        problem3_title: "Disconnected Systems", problem3_desc: "Integrate your platforms for a complete view and unified data.",
        services_title: "Intelligent Automation Solutions",
        service1_title: "IPA", service1_desc: "Orchestration of complex workflows with AI.",
        service2_title: "Advanced RPA", service2_desc: "Adaptable bots for critical tasks.",
        service3_title: "AI Integration", service3_desc: "Insights with Machine Learning and analytics.",
        service4_title: "Custom Solutions", service4_desc: "Unique development for specific challenges.",
        approach_tag: "Veridia Methodology", approach_title: "Strategic Collaboration, Measurable Results", approach_subtitle: "We integrate with your team to design and implement the perfect automation roadmap, focused on your key objectives.",
        approach_step1: "Diagnosis", approach_step2: "ROI Design", approach_step3: "Implementation", approach_step4: "Technology", approach_step5: "Support",
        approach_item1: "<strong class='list-strong'>Deep Diagnosis:</strong> Complete understanding of your processes and potential.",
        approach_item2: "<strong class='list-strong'>ROI-Focused Design:</strong> Custom solutions for maximum impact.",
        approach_item3: "<strong class='list-strong'>Agile Implementation:</strong> Iterative and transparent delivery.",
        approach_item4: "<strong class='list-strong'>Cutting-Edge Technology:</strong> Smart use of the best tools.",
        approach_item5: "<strong class='list-strong'>Continuous Support:</strong> Accompaniment in optimization and evolution.",
        value_title: "Measurable Transformation", value_subtitle: "Intelligent automation generates real, quantifiable value for your business.",
        value1_title: "Radical Efficiency", value1_desc: "Process acceleration and resource liberation.",
        value2_title: "Cost Reduction", value2_desc: "Expense optimization and profitability improvement.",
        value3_title: "Scalable Growth", value3_desc: "Capacity to expand without operational limitations.",
        value_cta: "Estimate Impact",
        contact_title: "Start the Conversation", contact_subtitle: "Discover how Veridia can design the perfect automation solution for your company.",
        form_name: "Name", form_name_placeholder: "Your Full Name",
        form_email: "Email", form_email_placeholder: "your.email@company.com",
        form_company: "Company (Optional)", form_company_placeholder: "Your Company Name",
        form_message: "Your main challenge or interest", form_message_placeholder: "Ex: Optimize billing, explore AI for data analysis...",
        form_submit: "Send Message",
        contact_email_prompt: "Or contact us via email:",
        footer_desc: "Intelligent automation for the future of business.", footer_nav: "Navigate", footer_capabilities: "Capabilities", footer_contact: "Contact",
        service_ipa_short: "IPA", service_rpa_short: "Advanced RPA", service_ai_short: "AI Integration", service_custom_short: "Custom Solutions",
        footer_rights: "All rights reserved.", footer_privacy: "Privacy Policy", footer_terms: "Terms of Service",
    },
    es: {
        nav_home: "Inicio", nav_services: "Servicios", nav_approach: "Nuestro Enfoque", nav_value: "Valor Potencial", nav_contact: "Contáctanos",
        hero_title: "Eficiencia y Futuro. <span class='text-accent'>Automatizados.</span>", hero_subtitle: "Veridia diseña e implementa soluciones de automatización inteligente que transforman tu operación y potencian tu crecimiento.", hero_cta: "Iniciar Consulta",
        problems_title: "Supera los Límites Operativos", problems_subtitle: "Identifica las barreras que frenan tu progreso y descubre cómo la automatización las derriba.",
        problem1_title: "Procesos Manuales Lentos", problem1_desc: "Libera a tu equipo de tareas repetitivas y propensas a errores.",
        problem2_title: "Costos Operativos Altos", problem2_desc: "Optimiza recursos y reduce gastos innecesarios con eficiencia.",
        problem3_title: "Sistemas Desconectados", problem3_desc: "Integra tus plataformas para una visión completa y datos unificados.",
        services_title: "Soluciones de Automatización Inteligente",
        service1_title: "IPA", service1_desc: "Orquestación de flujos complejos con IA.",
        service2_title: "RPA Avanzado", service2_desc: "Bots adaptables para tareas críticas.",
        service3_title: "Integración IA", service3_desc: "Insights con Machine Learning y analítica.",
        service4_title: "Soluciones a Medida", service4_desc: "Desarrollo único para desafíos específicos.",
        approach_tag: "Metodología Veridia", approach_title: "Colaboración Estratégica, Resultados Medibles", approach_subtitle: "Nos integramos con tu equipo para diseñar e implementar la hoja de ruta de automatización perfecta, enfocada en tus objetivos clave.",
        approach_step1: "Diagnóstico", approach_step2: "Diseño ROI", approach_step3: "Implementación", approach_step4: "Tecnología", approach_step5: "Soporte",
        approach_item1: "<strong class='list-strong'>Diagnóstico Profundo:</strong> Entendimiento completo de tus procesos y potencial.",
        approach_item2: "<strong class='list-strong'>Diseño Centrado en ROI:</strong> Soluciones a medida para un impacto máximo.",
        approach_item3: "<strong class='list-strong'>Implementación Ágil:</strong> Entrega iterativa y transparente.",
        approach_item4: "<strong class='list-strong'>Tecnología de Vanguardia:</strong> Uso inteligente de las mejores herramientas.",
        approach_item5: "<strong class='list-strong'>Soporte Continuo:</strong> Acompañamiento en la optimización y evolución.",
        value_title: "Transformación Medible", value_subtitle: "La automatización inteligente genera valor real y cuantificable para tu negocio.",
        value1_title: "Eficiencia Radical", value1_desc: "Aceleración de procesos y liberación de recursos.",
        value2_title: "Reducción de Costos", value2_desc: "Optimización de gastos y mejora de rentabilidad.",
        value3_title: "Crecimiento Escalable", value3_desc: "Capacidad para expandirse sin limitaciones operativas.",
        value_cta: "Estimar Impacto",
        contact_title: "Inicia la Conversación", contact_subtitle: "Descubre cómo Veridia puede diseñar la solución de automatización perfecta para tu empresa.",
        form_name: "Nombre", form_name_placeholder: "Tu Nombre Completo",
        form_email: "Correo Electrónico", form_email_placeholder: "tu.correo@empresa.com",
        form_company: "Empresa (Opcional)", form_company_placeholder: "Nombre de tu Compañía",
        form_message: "Tu principal desafío o interés", form_message_placeholder: "Ej: Optimizar facturación, explorar IA para análisis...",
        form_submit: "Enviar Mensaje",
        contact_email_prompt: "O contáctanos vía email:",
        footer_desc: "Automatización inteligente para el futuro de los negocios.", footer_nav: "Navegar", footer_capabilities: "Capacidades", footer_contact: "Contacto",
        service_ipa_short: "IPA", service_rpa_short: "RPA Avanzado", service_ai_short: "AI Integration", service_custom_short: "Custom Solutions",
        footer_rights: "Todos los derechos reservados.", footer_privacy: "Política de Privacidad", footer_terms: "Términos de Servicio",
    }
};
...
function setLanguage(lang) {
    ...
    document.querySelectorAll('[data-lang-key]').forEach(element => {
        ...
        if (translations[lang]?.[key]) {
            ...
            } else if (element.tagName === 'TEXT') { // Handle text nodes within SVG
...
function resizeCanvas() {
    ...
    if (newWidth > 0 && newHeight > 0) {
        ...
        return false; // No significant size change
         ...
         console.warn(`Footer dimensions invalid (${newWidth}x${newHeight}), skipping resize & particle creation.`);
...
class Particle {
    constructor() {
        ...
        this.color = isViolet ? `rgba(168, 85, 247, ${Math.random() * 0.7 + 0.45})` : `rgba(0, 209, 255, ${Math.random() * 0.6 + 0.4})`;
...
function handleResize() {
    ...
    if (resized && width > 0 && height > 0 && particles.length > 0 && !animationFrameId) {
         animate(); // Restart animation immediately after successful resize
         console.log("Animation restarted after resize.");
    } else if (!animationFrameId && width > 0 && height > 0 && particles.length > 0) {
        ...
        console.log(`Animation not started/restarted. Resized: ${resized}, Width: ${width}, Height: ${height}, Particles: ${particles.length}, FrameID: ${animationFrameId}`);
    }
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (mobileMenuButton && mobileMenu && menuIconOpen && menuIconClose && mobileMenuLinksContainer) {
     ...
     document.querySelectorAll('a[href^="#"]').forEach(anchor => {
        anchor.addEventListener('click', function (e) {
            ...
            const currentHeaderHeight = document.getElementById('main-header')?.offsetHeight || initialHeaderHeight;
            const elementPosition = targetElement.getBoundingClientRect().top; // Position relative to viewport
            const offsetPosition = window.pageYOffset + elementPosition - currentHeaderHeight; // Calculate final scroll position
    ...
    const desktopNavLinks = document.querySelectorAll('#desktop-menu-links a.nav-link'); // Desktop nav links
    const mobileNavLinks = document.querySelectorAll('#mobile-menu-links a.nav-link-mobile'); // Mobile nav links
    ...
    function updateActiveLink() {
        ...
        const activationOffset = (document.getElementById('main-header')?.offsetHeight || initialHeaderHeight) + 50;
        ...
        sections.forEach(section => {
         ...
         if (currentSectionId === '' && scrollPosition < (sections[0]?.offsetTop || 0) - activationOffset) {
    ...
    function handleScroll() {
        ...
        if (scrollIndicator) {
            const totalScroll = document.documentElement.scrollHeight - document.documentElement.clientHeight; // Total scrollable height
...
window.addEventListener('load', () => {
    ...
    if (canvas && ctx) {
        ...
        const initializeCanvasAnimation = () => {
            ...
            if (resizeCanvas()) { // Try resizing first, returns true if size changed
            ...
            if (width > 0 && height > 0 && particles.length > 0) {
                if (!animationFrameId) { // Start animation only if not already running
                 ...
                 console.error(`Cannot start animation on load: width=${width}, height=${height}, particles=${particles.length}.`);
        ...
        console.warn(`Footer canvas element (${canvas}) or 2D context (${ctx}) not found on window load. Animation skipped.`);
    }
});
